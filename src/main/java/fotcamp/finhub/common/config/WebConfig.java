...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/api/v1/admin/**")
                .allowedOrigins(mainOrigin, adminOrigin, devOrigin, "http://127.0.0.1:3000", "http://localhost:3000")  // Admin 프론트엔드 애플리케이션의 도메인
        ...
        registry.addMapping("/api/v1/main/**")
                .allowedOrigins(adminOrigin, mainOrigin, devOrigin, "http://127.0.0.1:3000", "http://localhost:3000")  // Main 프론트엔드 애플리케이션의 도메인
                .allowedMethods("GET", "POST", "PUT", "DELETE")
                .allowedHeaders("*")
                .allowCredentials(true);
